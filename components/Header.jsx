...
const Header = () => {
  ...
  return (
    // Header 
    <section className={[styles.header, styles.section, styles.container].join(" ")} id="header">
      <div className={styles.headerWrapper}>
        ...
        <div className={styles.headerBottom}>
          <div className={styles.headerImgWrapper}>
            <Image src="/img/home-img.png" className={styles.headerImg} width="1219" height="1055" alt="" />
          </div>
